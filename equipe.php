        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7 text-center">
                    <h2 class="mb-4">Contate-nos</h2>
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <a href="https://www.instagram.com/the_without_forest/">
                                <span class="fa-stack fa-lg">
                                    <i class="fas fa-circle fa-stack-2x"></i>
                                    <img src="assets/img/instaicon.png" class="fa-stack-1x" alt="Instagram Icon" style="width: 70%; height: 70%; object-fit: contain;">
                                </span>
                            </a>
                        </li>
                        <li class="list-inline-item">
                    ...
                    <div class="small text-muted fst-italic">Copyright &copy; Developed by Lucas Martins, Pedro Henrique, Tiago Estrada, Vinícius Ramos e Wesley Mendes</div>
                </div>
            </div>
        </div>
    </footer>
