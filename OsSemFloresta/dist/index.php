                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            ...
                            <h2>ㅤ</h2>
                            <h2>ㅤ</h2>
                            <h2>Conforto e tranquilidade, onde a sua estadia é um refúgio perfeito</h2>
                            <h2>ㅤ</h2>
                            <h2>ㅤ</h2>
                            <h1>ㅤ</h1>
                        </div>
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="post-preview">
                        <a href="sobreEspacos.php">
                            ...
                            <img  class="imginicio" src="assets/img/fazenda1soares.jpg" alt="">
                    ...
                    <div class="post-preview">
                        <a href="sobreEspacos.php">
                            ...
                            <img  class="imginicio" src="assets/img/fazenda2estrada.jpg" alt="">
                    ...
                    <br>
                    <div class="post-preview">
                        <a href="sobreEspacos.php"><h2 class="post-title">
                            <h2 class="post-title">Fazenda Ramos</h2>
                            <img  class="imginicio" src="assets/img/fazenda3ramos.jpg" alt="">
                    ...
                    <div class="post-preview">
                        <a href="sobreEspacos.php">
                            ...
                            <img  class="imginicio" src="assets/img/fazenda4medeiros.avif" alt="">
                    ...
                    <hr class="my-4" />
                    <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="sobreEspacos.php">Quero conhecer mais</a></div>
                </div>
            </div>
        </div>
